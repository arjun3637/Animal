var GameState = {
    preload: function(){
        ...
        this.load.audio('chickenSound', 'audio/chicken.mp3'); 
        this.load.audio('horseSound', 'audio/horse.mp3');
        this.load.audio('pigSound', 'audio/pig.mp3');
        this.load.audio('sheepSound', 'audio/sheep.mp3');
    ...
    create: function(){
       ...
       chickenSound = this.sound.add("chickenSound",1, {loop: false});
       horseSound = this.sound.add("horseSound",1, {loop: false});
       pigSound = this.sound.add("pigSound",1, {loop: false});
       sheepSound = this.sound.add("sheepSound",1, {loop: false});
